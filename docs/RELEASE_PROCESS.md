...
| 0.16.0 | 2026-08-18 | Stable | Update checker + tray notify, Right Alt PTT default (new installs), searchable language list, delete unused models, AGPL-3.0, family mic icons, IBus/audio/clipboard/GPU/AppImage reliability |
